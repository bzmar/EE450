...
# Clean target
clean:
	rm -f $(CLIENT_OBJ) $(SERVERM_OBJ) $(SERVERA_OBJ) $(SERVERD_OBJ) $(SERVERR_OBJ) $(SERVER_OBJ) $(CLIENT_EXE) $(SERVERM_EXE) $(SERVERA_EXE) $(SERVERD_EXE) $(SERVERR_EXE) $(DEPLOYED_FILE) $(LOG_FILE)
